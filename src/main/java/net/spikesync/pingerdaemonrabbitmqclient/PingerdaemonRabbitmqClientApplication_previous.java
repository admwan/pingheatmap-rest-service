...
public class PingerdaemonRabbitmqClientApplication_previous {

    private static final Logger logger = LoggerFactory.getLogger(PingerdaemonRabbitmqClientApplication_previous.class);
    ...
    PingerdaemonRabbitmqClientApplication_previous() {
...
//    	this.admin.declareQueue(new Queue(QUEUE_NAME, false, false, false, null));
    ...
    PingerdaemonRabbitmqClientApplication_previous(ApplicationContext appCtx) {
	...
	public static void main(String[] args) {
		...
		PingerdaemonRabbitmqClientApplication_previous pingDaemonApp = new PingerdaemonRabbitmqClientApplication_previous();
